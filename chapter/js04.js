...
let monthsFieldset = document.getElementsByTagName("fieldset")[2];  // Fixed missing semicolon
let fuelFieldset = document.getElementsByTagName("fieldset")[3];  // Fixed missing quotation mark
...
let W1205Desc = "Can't be beat for the general tasks of a large farm. Medium- to heavy-duty muscle that's there when you need it.";
...
function createRecommendation() {
   ...
   // Add fuel type to the tractor recommendation
   if (document.getElementById("E85").checked) { // add suffix to model name based on fuel choice
      ...
      messageHeadElement.innerHTML += "B";  // Fixed the fuel logic
   } else {
